        ...
        <form>
          <div class="card-body">
              ...
              <div class="input-group">
                ...
                <div class="input-group-btn">
                  <div class="fileUpload btn btn-danger fake-shadow">
                    ...
                    <input id="logo-id" required name="logo" type="file" class="attachment_upload">
                  </div>
                </div>
              </div>
            ...
            <div class="form-group">
              ...
              <input type="number" required class="form-control" id="phone" placeholder="Enter Phone">
            </div>

            <div class="form-group">
              <label for="name">Password <span style="color:red">*</span></label>
              <input type="text" required class="form-control" id="name" placeholder="Enter Password">
            </div>

            <div class="form-group">
              <label for="refer">Refer Point <span style="color:red">*</span></label>
              <input type="number" required class="form-control" id="refer" placeholder="Enter Point" value="0">
            </div>

            <div class="form-group">
              <label for="refer_code">Refer Code <span style="color:red">*</span></label>
              <input type="number" required class="form-control" id="refer_code" placeholder="Enter Refer Code" >
            </div>
    
            <div class="form-group">
              <label for="desc">Address <span style="color:red">*</span></label>
              <textarea required type="text" class="form-control" id="desc" placeholder="Enter Address"></textarea>
            </div>
